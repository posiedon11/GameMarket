...
namespace GameMarketAPIServer.Migrations
{
    ...
    [Migration("20240429092206_FIRST")]
    partial class FIRST
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameMarketAPIServer.Models.DataBaseSchemas+SteamSchema+AppDetailsTable", b =>
                {
                    ...
                    b.Property<DateTime>("lastScanned")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 29, 9, 22, 6, 211, DateTimeKind.Utc).AddTicks(6219));
            ...
            modelBuilder.Entity("GameMarketAPIServer.Models.DataBaseSchemas+SteamSchema+PackageDetailsTable", b =>
                {
                    ...
                    b.Property<DateTime>("lastScanned")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 29, 9, 22, 6, 214, DateTimeKind.Utc).AddTicks(8425));
