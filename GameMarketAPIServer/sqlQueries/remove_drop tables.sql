...
update xbox.gametitles set lastScanned = null, groupID = null;
update xbox.userprofiles set lastScanned = null;
update xbox.productids set lastscanned = null;
update xbox.gametitles set lastScanned = null where moderntitleId IN (
select modernTitleId from xbox.titledetails group by moderntitleId having count(productID) = 1);
